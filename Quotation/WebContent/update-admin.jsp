...
<html lang="en">
<head>
    <title>Update Admin | BlueBanyan</title>
    <meta charset="utf-8" />
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card card-topline-green">
								<div class="card-head">
									<header>Update Old Admin</header>
									<div class="tools">
                                        <a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
	                                    <a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
                                    </div>
								</div>
								<form method="post" action="<%=Config.getBaseUrl()%>/UpdateOldPassword">
								<div class="card-body row">
						            ...
						            <div class="col-lg-12 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input type="password" class="mdl-textfield__input" id ="" name="old_password" required/>
					                     <label class="mdl-textfield__label">Old Password</label>
					                  </div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input type="password" class="mdl-textfield__input" id ="" name="new_password" required/>
