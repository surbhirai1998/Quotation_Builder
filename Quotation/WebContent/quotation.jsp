...
<%
	...
	if(request.getParameter("p_id").toString()==null && request.getParameter("p_id").toString().trim()=="" ){
		response.sendRedirect(Config.getBaseUrl()+"/AllQuotations");
	}
	int p_id=Integer.parseInt(request.getParameter("p_id"));
	Quotation quotation = null;
	quotation = pdao.getQuotation(p_id);
						...
						<div class="col-sm-12">
							<div class="card card-topline-aqua" style="margin-bottom:180px;">
								...
								<div class="card-body row">
						            ...
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="email" class="mdl-textfield__input" id ="" value="${quotation.client.email}" name="" readonly/>
					                     	<label class="mdl-textfield__label">Email</label>
					                  	</div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="text" class="mdl-textfield__input" id ="" name="" value="${quotation.client.contactNumber}" readonly/>
					                     	<label class="mdl-textfield__label">Contact Number</label>
					                  	</div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="text" class="mdl-textfield__input" id ="" name="" value="${quotation.client.country}" readonly/>
					                     	<label class="mdl-textfield__label">Country</label>
					                  	</div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="text" class="mdl-textfield__input" id ="" name="" value="${quotation.client.state}" readonly/>
					                     	<label class="mdl-textfield__label">State</label>
					                  	</div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="text" class="mdl-textfield__input" id ="" name="" value="${quotation.client.city}" readonly/>
					                     	<label class="mdl-textfield__label">City</label>
					                  	</div>
						            </div>
						            <form action="<%=Config.getBaseUrl()%>/UpdateClientData" method="post" >
						            ...
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     	<input type="text" class="mdl-textfield__input" id ="date" name="" placeholder="Date" value="${quotation.project.term}" readonly/>
					                  	</div>
						            </div>
						            <div class="col-lg-12 p-t-20"> 
						              	<div class = "mdl-textfield mdl-js-textfield txt-full-width">
					                     	<textarea class = "mdl-textfield__input" rows="2" id = "text7" >${quotation.project.extraNote}</textarea>
					                     	<label class = "mdl-textfield__label" for = "text7">Note</label>
					                  	</div>
						            </div>
						            <form action="<%=Config.getBaseUrl()%>/UpdateProjectData" method="post">
										<input type="hidden" value="${quotation.project.pid}" name="p_id">
										<button class="btn btn-block btn-secondary" type="submit">Edit project details</button>
									</form>
									<div class="col-sm-12" style="height:20px;"></div>
						            <h2>Services </h2>
						            <c:forEach varStatus="loopCounter" var="ms" items="${quotation.project.mainServices}">
						            	<div class="col-lg-12" style="margin-bottom:20px;">
						           	 		<div class="row"> 
						           	 			<div class="col-sm-6">
						            				<h5 class="ser-title" style="font-weight: bold;" >${ms.mainService}</h5>
						           	 			</div>
						           	 			<div class="col-sm-6">
						            				<h5 class="ser-title"  style="font-weight: bold;">Cost :  Rs. ${ms.cost}</h5>
						            			</div>
						            		</div>
						            		<hr style="margin: 2px;">
						            		<c:forEach var="ss" varStatus="innerLoop" items="${ms.subServices}">
						            			<div class="col-lg-12 p-t-20"> 
													<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="_">
											  			<input type="checkbox" id="_" class="mdl-checkbox__input" value="${ss.description}" checked disabled>
											  			<input type="text" class="mdl-textfield__input service-input" id ="" name="" value="${ss.description}" readonly />
													</label>
							            		</div>
							            	</c:forEach>
						            	</div>
									...
									<form action="<%=Config.getBaseUrl()%>/UpdateServicesData" method="post">
										<input type="hidden" value="${quotation.project.pid}" name="p_id">
										<button class="btn btn-secondary btn-block" type="submit">Edit Services details</button>
									</form>
					            	<div class="col-sm-12" style="height:50px"></div>
									<form method="post" action="<%=Config.getBaseUrl()%>/QuotationPdf" target="_blank">
										<input type="hidden" value="${quotation.client.id}" name="c_id">
										<input type="hidden" value="${quotation.project.pid}" name="p_id">
										<button class="btn btn-success btn-block" type="submit">Make Quotation</button>
									</form>
								</div>
								<div class="col-sm-12" style="height:50px"></div>
							</div>
