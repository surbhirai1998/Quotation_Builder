					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card card-topline-green">
								...
								<h5 style=" margin-left:30px; color:red;">The client already exists. </h5>
								<div class="card-body row">
						            ...
						            <div class="col-lg-12 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input type="text" class="mdl-textfield__input" id ="" name="contactNumber" required pattern="[0-9]{10}"/>
